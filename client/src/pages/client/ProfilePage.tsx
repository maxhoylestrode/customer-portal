            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input type="text" className="input" {...profileForm.register('company_name')} />
                </div>
              </div>
              <div>
                <label className="label">Website URL</label>
                <input type="url" className="input" {...profileForm.register('website_url')} />
                {profileForm.formState.errors.website_url && (
                  <p className="error-text">{profileForm.formState.errors.website_url.message}</p>
                )}
              </div>
            ...
            <div className="card px-5 py-5">
              ...
              <dl className="space-y-3">
                ...
                <InfoRow
                  ...
                  value={
                    user?.website_url ? (
                      <a href={user.website_url} target="_blank" rel="noopener noreferrer" className="text-[#1A5276] hover:underline">
                        {user.website_url}
                      </a>
                    ) : '—'
                  }
